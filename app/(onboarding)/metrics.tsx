            ...
            <View className="flex-row items-center">
              ...
              <View className="flex-1 justify-center max-w-[400px] px-[10px]">
                <View className="mb-[15px]">
                  ...
                  <TextInput value={age} onChangeText={setAge} className="bg-[#ffffff] py-[20px] w-full mb-[10px] rounded-xl border-[1px] pl-[20px] mr-[10px]"  placeholderTextColor="#c4c4c6" placeholder='19'></TextInput>
                </View>
                ...
                <View className="flex-row items-center justify-center">
                  <TextInput value={height} onChangeText={setHeight} className="bg-[#ffffff] py-[20px] w-[180px] mb-[10px] rounded-xl border-[1px] pl-[20px] mr-[10px]"  placeholderTextColor="#c4c4c6" placeholder='5&apos;11&quot;'></TextInput>
                  <TextInput value={weight} onChangeText={setWeight} className="bg-[#ffffff] py-[20px] w-[180px] mb-[10px] rounded-xl border-[1px] pl-[20px]"  placeholderTextColor="#c4c4c6" placeholder='120'></TextInput>
                </View>
              </View>
