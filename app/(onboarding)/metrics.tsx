      ...
      <View className="flex-1 justify-center max-w-[400px] px-[10px]">
        <View className="mb-[15px]">
          ...
          <TextInput
            ...
            className="bg-[#ffffff] py-[20px] w-full mb-[10px] rounded-xl border-[1px] pl-[20px] mr-[10px]"
        ...
        <View className="flex-row items-center justify-center">
          <TextInput
            ...
            className="bg-[#ffffff] py-[20px] w-[180px] mb-[10px] rounded-xl border-[1px] pl-[20px] mr-[10px]"
            placeholderTextColor="#c4c4c6"
            placeholder="170 cm"
          ></TextInput>
          <TextInput
