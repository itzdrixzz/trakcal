      ...
      <View className="">
        <View className="  flex-row items-center mx-[20px] mt-[10px]">
          ...
          <Text className="text-xl font-semibold text-center absolute left-1/2 -translate-x-1/2">
            {t(
              "settingsPage.goalsAndTrackingSection.trackingRemindersPage.remindersHeaderText",
            )}
          </Text>
        </View>
        <View className="mx-[20px] border-[1px] border-[#eaeced] mt-[30px] rounded-lg h-[100px]">
          <Text className="text-base font-medium mt-[10px] ml-[10px]">
            {t(
              "settingsPage.goalsAndTrackingSection.trackingRemindersPage.notificationsDisabledText",
            )}
          </Text>
          <TouchableOpacity className="flex-row items-center ml-[10px] mt-[5px]">
            <Text className="text-lg font-semibold">
              {t(
                "settingsPage.goalsAndTrackingSection.trackingRemindersPage.openSettingsButton",
              )}
            </Text>
        ...
        <View className=" mx-[20px] mt-[40px]">
          <Text className="text-3xl font-bold text">
            {t(
              "settingsPage.goalsAndTrackingSection.trackingRemindersPage.trackingRemindersHeaderText",
            )}
          </Text>
          <View className="">
            <View className=" mt-[30px] border-[1px] border-[#eaeced] rounded-lg">
              <View className=" mx-[10px] my-[10px] items-center flex-row">
                <Text className="text-lg font-semibold py-[10px]">
                  {t(
                    "settingsPage.goalsAndTrackingSection.trackingRemindersPage.breakfastText",
                  )}
                </Text>
              ...
              <View className=" mx-[10px] my-[10px] items-center flex-row">
                <Text className="text-lg font-semibold py-[10px]">
                  {t(
                    "settingsPage.goalsAndTrackingSection.trackingRemindersPage.lunchText",
                  )}
                </Text>
                <TouchableOpacity className="bg-[#000000] rounded-full absolute right-[15px] py-[10px] px-[15px]">
              ...
              <View className=" mx-[10px] my-[10px] items-center flex-row">
                <Text className="text-lg font-semibold py-[10px]">
                  {t(
                    "settingsPage.goalsAndTrackingSection.trackingRemindersPage.snackText",
                  )}
                </Text>
                <TouchableOpacity className="bg-[#000000] rounded-full absolute right-[15px] py-[10px] px-[15px]">
              ...
              <View className=" mx-[10px] my-[10px] items-center flex-row">
                <Text className="text-lg font-semibold py-[10px]">
                  {t(
                    "settingsPage.goalsAndTrackingSection.trackingRemindersPage.DinerText",
                  )}
                </Text>
                <TouchableOpacity className="bg-[#000000] rounded-full absolute right-[15px] py-[10px] px-[15px]">
